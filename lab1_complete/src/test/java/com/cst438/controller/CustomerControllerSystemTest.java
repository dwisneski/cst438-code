...
public class CustomerControllerSystemTest {
    ...
    @Test
    public void createOrderSystemTest() throws InterruptedException {
        Alert alert;
    ...
    public void createAndEditOrder() throws InterruptedException {
        Alert alert;
        int randomInt = random.nextInt(100, 1000);
        String testItem = "testitem"+randomInt;
        // login
        driver.findElement(By.id("home")).click();
        driver.findElement(By.id("email")).sendKeys("tom@csumb.edu");
        ...
        driver.findElement(By.id("history")).click();
        // check that order item123 is listed in the table
        WebElement we = driver.findElement(By.xpath("//tr/tc[text()='" + testItem + "']"));
        assertNotNull(we);
        // click the edit button for the test item
        we.findElement(By.id("editButton")).click();
        ...
        we = driver.findElement(By.xpath("//tr/tc[text()='10']"));
    ...
    @Test
    public void createBadOrderSystemTest() throws InterruptedException {
        Alert alert;
        int randomInt = random.nextInt(100, 1000);
        String email = "test"+randomInt+"@csumb.edu";
        // register
        ...
        WebElement we = driver.findElement(By.xpath("//li[text()='Order quantity must be greater than 0']"));
        assertNotNull(we);
    ...
    @Test
    public void registerBadEmailFailsSystemTest() {
